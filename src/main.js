  ...
  document
    ...
    .addEventListener("click", function (e) {
      if (document.querySelector(".menu-wrap").classList.contains("on")) {
        ...
        document.querySelector(".icon-hamburger").src =
          "./img/icon-hamburger.png";
        document.querySelector(".mobile-menu").style.backgroundColor =
          "rgba( 255, 255, 255, 0 )";
...
function changeSection(num) {
  if (num == 1) {
    ...
    document.getElementById("myChart").style =
      "background-color: #001338; background-size: 100%;";
    document.getElementById("popup-layer-background").style =
      "background-color: #001338; background-size: 100%;";
    ...
    if (screen.width > 901) {
      document.getElementById("chart-legend").src =
        "./img/legend/chart1_1_web.png";
      document.getElementById("chart-legend").style =
        "width: 164px; height: auto; padding-top: 20px;";
      document.getElementById("chart-container").style = "flex-direction: row;";
    } else {
      document.getElementById("chart-legend-mobile").srcset =
        "./img/legend/chart1_1_mobile.png";
      document.getElementById("chart-legend").style =
  ...
  if (num == 2) {
    ...
    document.getElementById("myChart").style =
      "background-color: #260A0B; background-size: 100%;";
    document.getElementById("popup-layer-background").style =
      "background-color: #260A0B; background-size: 100%;";
...
function changeMenuNum(num) {
  ...
  if (num == 1) {
    ...
    document.getElementById("menu1-container").style =
      "background-color: rgba(255, 255, 255,0.1);";
    document.getElementById("menu2").src = "./img/normal_2.png";
    document.getElementById("menu2-container").style =
      "background-color: none;";
    document.getElementById("menu3").src = "./img/normal_3.png";
    document.getElementById("menu3-container").style =
      "background-color: none;";
    document.getElementById("chart-status").innerHTML = "1/10";
    ...
    if (screen.width > 901) {
      document.getElementById("chart-legend").src =
        "./img/legend/chart1_1_web.png";
      document.getElementById("chart-legend").style =
        "width: 178px; height: auto; padding-top: 100px;";
      document.getElementById("chart-container").style = "flex-direction: row;";
    } else {
      document.getElementById("chart-legend-mobile").srcset =
        "./img/legend/chart1_1_mobile.png";
  ...
  if (num == 2) {
    ...
    if (screen.width > 901) {
      document.getElementById("chart-legend").src =
        "./img/legend/chart2_1_web.png";
      document.getElementById("chart-legend").style =
        "width: 178px; height: auto; padding-top: 100px;";
      document.getElementById("chart-container").style = "flex-direction: row;";
    } else {
      document.getElementById("chart-legend-mobile").srcset =
        "./img/legend/chart2_1_mobile.png";
      document.getElementById("chart-legend").style =
        "width:300px; padding-top: 20px;";
    }
  }
  if (num == 3) {
    ...
    document.getElementById("menu3-container").style =
      "background-color: rgba(255, 255, 255,0.1);";
    document.getElementById("chart-status").innerHTML = "1/10";
    document.getElementById("sub-title-1").innerHTML =
      "북한사회변동조사";
    document.getElementById("sub-title-2").innerHTML = "북한이탈주민 대상";
    if (screen.width > 901) {
      document.getElementById("chart-legend").src =
        "./img/legend/chart3_1_web.png";
      document.getElementById("chart-legend").style =
        "width: 234px; height: auto; padding-top: 100px;";
      document.getElementById("chart-container").style = "flex-direction: row;";
    } else {
      document.getElementById("chart-legend-mobile").srcset =
        "./img/legend/chart3_1_mobile.png";
      document.getElementById("chart-legend").style =
        "width:300px; padding-top: 20px;";
    }
  }
  if (num == 4) {
    ...
    document.getElementById("menu4-container").style =
      "background-color: rgba(255, 255, 255,0.1);";
    document.getElementById("menu5").src = "./img/normal_5.svg";
    document.getElementById("menu5-container").style =
      "background-color: none;";
  ...
  if (num == 5 || num == 6) {
    ...
    if (screen.width > 901) {
      document.getElementById("chart-legend").src =
        "./img/legend/chart6_web.png";
      document.getElementById("chart-legend").style =
        "width: 172px; height: auto; padding-top: 20px;";
      document.getElementById("chart-container").style = "flex-direction: row;";
    } else {
      document.getElementById("chart-legend-mobile").srcset =
        "./img/legend/chart6_mobile.png";
      document.getElementById("chart-legend").style =
        "width:300px; padding-top: 20px;";
    }
  }
  if (num == 7) {
    ...
    if (screen.width > 901) {
      document.getElementById("chart-legend").src =
        "./img/legend/chart7_web.png";
      document.getElementById("chart-legend").style =
        "width: 166px; height: auto; padding-top: 20px;";
      document.getElementById("chart-container").style = "flex-direction: row;";
    } else {
      document.getElementById("chart-legend-mobile").srcset =
        "./img/legend/chart7_mobile.png";
      document.getElementById("chart-legend").style =
        "width:300px; padding-top: 20px;";
    }
  }
  ...
  if (num == 9 || num == 10) {
    ...
    document.getElementById("menu10-container").style =
      "background-color: none;";
    ...
    if (screen.width > 901) {
      document.getElementById("chart-legend").src =
        "./img/legend/chart9_web.png";
      document.getElementById("chart-legend").style =
        "width: 163px; height: auto; padding-top: 20px;";
      document.getElementById("chart-container").style = "flex-direction: row;";
    } else {
      document.getElementById("chart-legend-mobile").srcset =
        "./img/legend/chart9_mobile.png";
      document.getElementById("chart-legend").style =
        "width:300px; padding-top: 20px;";
    }
  }
  if (num == 11) {
    ...
    if (screen.width > 901) {
      document.getElementById("chart-legend").src =
        "./img/legend/chart11_web.png";
      document.getElementById("chart-legend").style =
        "width: 141px; height: auto; padding-top: 20px;";
      document.getElementById("chart-container").style = "flex-direction: row;";
    } else {
      document.getElementById("chart-legend").style =
        "width:300px; padding-top: 20px;";
      document.getElementById("chart-legend-mobile").srcset =
        "./img/legend/chart11_mobile.png";
    }
  }
}
...
function fnMoveNextChart(num) {
  if (num == 1) {
    ...
    if (curChartNum == 2) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart1_2_web.png";
        document.getElementById("chart-legend").style =
          "width: 500px; height: auto; padding-top: 20px;";
        document.getElementById("chart-container").style =
          "flex-direction: column;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart1_2_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 3) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart1_3_web.png";
        document.getElementById("chart-legend").style =
          "width: 250px; height: auto; padding-top: 100px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart1_3_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 4) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart1_4_web.png";
        document.getElementById("chart-legend").style =
          "width: 167px; height: auto; padding-top: 120px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart1_4_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 5) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart1_5_web.png";
        document.getElementById("chart-legend").style =
          "width: 210px; height: auto; padding-top: 100px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart1_5_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 6) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart1_6_web.png";
        document.getElementById("chart-legend").style =
          "width: 129px; height: auto; padding-top: 100px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart1_6_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 7) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart1_7_web.png";
        document.getElementById("chart-legend").style.width = "152px";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart1_7_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 8) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart1_8_web.png";
        document.getElementById("chart-legend").style =
          "width: 173px; height: auto; padding-top: 120px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart1_8_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 9) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart1_9_web.png";
        document.getElementById("chart-legend").style =
          "width: 148px; height: auto; padding-top: 100px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart1_9_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 10) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart1_10_web.png";
        document.getElementById("chart-legend").style =
          "width: 148px; height: auto; padding-top: 120px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart1_10_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
  }
  if (num == 2) {
    ...
    if (curChartNum == 2) {
      ...
      if (screen.width > 901) {
        ...
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart2_2_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 3) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart2_3_web.png";
        document.getElementById("chart-legend").style =
          "width: 238px; height: auto; padding-top: 100px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart2_3_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 4) {
      ...
      if (screen.width > 901) {
        ...
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart2_4_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 5) {
      ...
      if (screen.width > 901) {
        ...
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart2_5_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 6) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart2_6_web.png";
        document.getElementById("chart-legend").style =
          "width: 164px; height: auto; padding-top: 100px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart2_6_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 7) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart2_7_web.png";
        document.getElementById("chart-legend").style =
          "width: 118px; height: auto; padding-top: 100px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart2_7_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 8) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart2_8_web.png";
        document.getElementById("chart-legend").style =
          "width: 149px; height: auto; padding-top: 100px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart2_8_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 9) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart2_9_web.png";
        document.getElementById("chart-legend").style =
          "width: 134px; height: auto; padding-top: 100px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart2_9_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 10) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart2_10_web.png";
        document.getElementById("chart-legend").style =
          "width: 168px; height: auto; padding-top: 100px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart2_10_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
  }
  if (num == 3) {
    ...
    if (curChartNum == 2) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart3_2_web.png";
        document.getElementById("chart-legend").style =
          "width: 123px; height: auto; padding-top: 130px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart3_2_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 3) {
      ...
      if (screen.width > 901) {
        ...
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart3_3_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 4) {
      ...
      if (screen.width > 901) {
        ...
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart3_4_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 5) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart3_5_web.png";
        document.getElementById("chart-legend").style =
          "width: 223px; height: auto; padding-top: 140px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart3_5_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 6) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart3_6_web.png";
        document.getElementById("chart-legend").style =
          "width: 295px; height: auto; padding-top: 120px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart3_6_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 7) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart3_7_web.png";
        document.getElementById("chart-legend").style =
          "width: 203px; height: auto; padding-top: 100px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart3_7_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 8) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart3_8_web.png";
        document.getElementById("chart-legend").style =
          "width: 235px; height: auto; padding-top: 120px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart3_8_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 9) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart3_9_web.png";
        document.getElementById("chart-legend").style =
          "width: 266px; height: auto; padding-top: 120px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart3_9_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
    if (curChartNum == 10) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart3_10_web.png";
        document.getElementById("chart-legend").style =
          "width: 108px; height: auto; padding-top: 100px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
          "./img/legend/chart3_10_mobile.png";
        document.getElementById("chart-legend").style.width = "300px";
      }
    }
  }
    ...
    if (curChartNum == 4) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart1_4_web.png";
        document.getElementById("chart-legend").style =
          "width: 167px; height: auto; padding-top: 100px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
    ...
    if (curChartNum == 7) {
      ...
      if (screen.width > 901) {
        document.getElementById("chart-legend").src =
          "./img/legend/chart1_7_web.png";
        document.getElementById("chart-legend").style =
          "width: 152px; height: auto; padding-top: 100px;";
        document.getElementById("chart-container").style =
          "flex-direction: row;";
      } else {
        document.getElementById("chart-legend-mobile").srcset =
  ...
  if (num == 2) {
    ...
    function unitySecond(chartFunction, statusNumber, option, flex = "row") {
      ...
      if (screen.width > 901) {
        document.getElementById(
          "chart-legend"
        ).src = `./img/legend/chart2_${statusNumber}_web.png`;
        document.getElementById(
          "chart-legend"
        ...
        document.getElementById(
          "chart-legend-mobile"
        ).srcset = `./img/legend/chart2_${statusNumber}_mobile.png`;
        document.getElementById("chart-legend").style = "300px";
      }
    }
    const aa = {
    ...
    if (curChartNum == 2) {
      unitySecond(
        fnChart2Uni03,
        curChartNum,
        { width: "500px", height: "auto", padding: "20px" },
        "column"
      );
    }
    if (curChartNum == 3) {
